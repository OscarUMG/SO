                            ...
                            <div class="col-lg-6">
                                <div class="contact-detail-container">
                                    <div class="section-head">
                                        ...
                                        <h2 class="section-title">Puedes ponerte en contacto con nosotros!</h2>
                                        <div class="section-disc">
                                            <p>Por favor, proporciona la información requerida a continuación y te responderemos a la brevedad. Tu opinión es valiosa para nosotros, 
                                                y estamos comprometidos a brindarte el mejor servicio posible.</p>
                                        </div>
                                    </div>
                                    <div class="contact-details-list">
                                        <ul>
                                            ...
                                            <li>
                                                ...
                                                <div class="details-content">
                                                    <h5>Dirección :</h5>
                                                    <span>7a. Calle, 3-29 Zona 4</span>
                                                    <span>Colegio Esteca, Sanarate, El Progreso</span>
                                                </div>
                                            </li>
                                            <li>
                                                <span class="icon">
                                                ...
                                                <div class="details-content">
                                                    ...
                                                    <span>info@soumgsanarate.com</span>
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
